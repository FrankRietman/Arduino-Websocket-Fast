...
bool WebSocketClient::analyzeRequest()
{
    ...
    Serial.println(" CRLF");
    Serial.print("User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36");
    Serial.println(" CRLF");
    ...
    // "Host: fm-2-30-demo-fleet.extern.romias.nl CRLF"
    ...
    socket_client->print(F("Cookie: "));
    socket_client->print(cookie);
    socket_client->print(CRLF);
